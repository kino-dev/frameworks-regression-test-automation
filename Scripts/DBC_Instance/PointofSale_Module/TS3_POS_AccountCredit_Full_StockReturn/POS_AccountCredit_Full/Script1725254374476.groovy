...
WebUI.click(findTestObject('Object Repository/TS3_POS_AccountCredit_Full/Page_Frameworks (Demo)/table_Despatch Method_isc_OV'))

WebUI.click(findTestObject('Object Repository/TS3_POS_AccountCredit_Full/Page_Frameworks (Demo)/div_PickU - Pick up'))

WebUI.setText(findTestObject('Object Repository/TS3_POS_AccountCredit_Full/Page_Frameworks (Demo)/input_Address_deliverToAddress1'), 
    '10 chila road')

WebUI.setText(findTestObject('Object Repository/TS3_POS_AccountCredit_Full/Page_Frameworks (Demo)/input_State_deliverToAddress3'), 
    'VIC')

WebUI.click(findTestObject('Object Repository/TS3_POS_AccountCredit_Full/Page_Frameworks (Demo)/div_VIC - Victoria'))

WebUI.click(findTestObject('Object Repository/TS3_POS_AccountCredit_Full/Page_Frameworks (Demo)/div_Finish (S)'))

WebUI.click(findTestObject('Object Repository/TS3_POS_AccountCredit_Full/Page_Frameworks (Demo)/div_Refund'))
