...
WebUI.click(findTestObject('Object Repository/TS4_POS_AccountCredit_Partial/Page_Frameworks (Demo)/td_State_isc_QJ'))

WebUI.click(findTestObject('Object Repository/TS4_POS_AccountCredit_Partial/Page_Frameworks (Demo)/div_VIC - Victoria (1)'))
