...
WebUI.setText(findTestObject('Object Repository/Sales_Orders_CHC/Page_Frameworks (Demo)/Page_Frameworks (Demo)/input_User ID_userid'), 
    userName)

WebUI.setEncryptedText(findTestObject('Object Repository/Sales_Orders_CHC/Page_Frameworks (Demo)/Page_Frameworks (Demo)/input_Password_password'), 
    'BvRmjN+0xFM=')
...
WebUI.click(findTestObject('Page_Frameworks (Demo)/div_Login'))

WebUI.click(findTestObject('Object Repository/Validate_SO_Quote_Account/Page_Frameworks (Demo)/Fws_Menu'))

WebUI.click(findTestObject('Object Repository/Validate_SO_Quote_Account/Page_Frameworks (Demo)/Sales_TransactionProcessing'))

WebUI.click(findTestObject('Object Repository/Validate_SO_Quote_Account/Page_Frameworks (Demo)/td_Sales Orders'))

WebUI.click(findTestObject('Object Repository/Validate_SO_Quote_Account/Page_Frameworks (Demo)/div_New'))
...
//
//WebUI.click(findTestObject('Object Repository/Sales_Orders_CHC/Page_Frameworks (Demo)/div_OK'))
WebUI.setText(findTestObject('Object Repository/Validate_SO_Quote_Account/Page_Frameworks (Demo)/input_Customer_idCustX'), 
    'Lee Pearce')

WebUI.click(findTestObject('Object Repository/Validate_SO_Quote_Account/Page_Frameworks (Demo)/div_Lee Pearce (518451)'))

WebUI.click(findTestObject('Object Repository/Validate_SO_Quote_Account/Page_Frameworks (Demo)/input_Cust Order_custOrderRef'))

WebUI.delay(2)

WebUI.click(findTestObject('Object Repository/Validate_SO_Quote_Account/Page_Frameworks (Demo)/td_Close (O)'))

WebUI.click(findTestObject('Page_Frameworks (Demo)/img_Order Branch'))

WebUI.click(findTestObject('Page_Frameworks (Demo)/div_510 - DEMONSTRATION BRANCH 510'))

WebUI.click(findTestObject('Object Repository/Validate_SO_Quote_Account/Page_Frameworks (Demo)/img_Desp. Method_isc_12H'))

WebUI.click(findTestObject('Object Repository/Validate_SO_Quote_Account/Page_Frameworks (Demo)/div_SUPP - Supplier Direct Delivery'))

WebUI.click(findTestObject('Object Repository/Validate_SO_Quote_Account/Page_Frameworks (Demo)/img_Date Required_isc_12O'))

WebUI.click(findTestObject('Object Repository/Validate_SO_Quote_Account/Page_Frameworks (Demo)/td_Today'))

WebUI.setText(findTestObject('Object Repository/Validate_SO_Quote_Account/Page_Frameworks (Demo)/input_Address_deliverToAddress2'), 
    '154 Scott Street')

WebUI.setText(findTestObject('Object Repository/Validate_SO_Quote_Account/Page_Frameworks (Demo)/input_SuburbCity_deliverToAddress3'), 
    'Cairns')

WebUI.scrollToElement(findTestObject('Object Repository/Validate_SO_Quote_Account/Page_Frameworks (Demo)/img_Delivery Area_isc_18U'), 
    2)

WebUI.click(findTestObject('Object Repository/Validate_SO_Quote_Account/Page_Frameworks (Demo)/img_State_isc_14Q'))

WebUI.click(findTestObject('Object Repository/Validate_SO_Quote_Account/Page_Frameworks (Demo)/div_QLD - Queensland'))

WebUI.setText(findTestObject('Object Repository/Validate_SO_Quote_Account/Page_Frameworks (Demo)/input_Post Code_postCodeShip'), 
    '4870')

WebUI.click(findTestObject('Object Repository/Validate_SO_Quote_Account/Page_Frameworks (Demo)/img_Delivery Area_isc_18U'))

WebUI.click(findTestObject('Object Repository/Validate_SO_Quote_Account/Page_Frameworks (Demo)/a_Expo'))

WebUI.takeFullPageScreenshot()

WebUI.click(findTestObject('Object Repository/Validate_SO_Quote_Account/Page_Frameworks (Demo)/td_Save (S)'))

WebUI.delay(8)

salesorder_Number = WebUI.getText(findTestObject('Object Repository/Validate_SO_Quote_Account/Page_Frameworks (Demo)/span_SOnumber'))

WebUI.setText(findTestObject('Object Repository/Validate_SO_Quote_Account/Page_Frameworks (Demo)/input_P_idProd'), '5155103')

WebUI.click(findTestObject('Object Repository/Validate_SO_Quote_Account/Page_Frameworks (Demo)/input_Quantity_qtyTran'), 
    FailureHandling.STOP_ON_FAILURE)

WebUI.delay(3)

WebUI.setText(findTestObject('Object Repository/Validate_SO_Quote_Account/Page_Frameworks (Demo)/input_Tally_tallyText'), 
    '1/3')

WebUI.takeFullPageScreenshot()

WebUI.click(findTestObject('Object Repository/Validate_SO_Quote_Account/Page_Frameworks (Demo)/img_add'))

WebUI.takeFullPageScreenshot()

WebUI.click(findTestObject('Object Repository/Validate_SO_Quote_Account/Page_Frameworks (Demo)/div_Actions'))

WebUI.takeFullPageScreenshot()

WebUI.click(findTestObject('Object Repository/Validate_SO_Quote_Account/Page_Frameworks (Demo)/div_Save Order'))
...
WebUI.click(findTestObject('Object Repository/Validate_SO_Quote_Account/Page_Frameworks (Demo)/div_Mark as Entry Complete'))

WebUI.takeFullPageScreenshot()

WebUI.click(findTestObject('Object Repository/Validate_SO_Quote_Account/Page_Frameworks (Demo)/img_Save_icon'))

WebUI.click(findTestObject('Object Repository/Validate_SO_Quote_Account/Page_Frameworks (Demo)/div_Actions'))

WebUI.takeFullPageScreenshot()

WebUI.click(findTestObject('Object Repository/Validate_SO_Quote_Account/Page_Frameworks (Demo)/div_Pick  Release'))

WebUI.takeFullPageScreenshot()

WebUI.click(findTestObject('Object Repository/Validate_SO_Quote_Account/Page_Frameworks (Demo)/div_Pick All'))

WebUI.takeFullPageScreenshot()

WebUI.click(findTestObject('Object Repository/Validate_SO_Quote_Account/Page_Frameworks (Demo)/div_Complete Picking'))

WebUI.takeFullPageScreenshot()

WebUI.click(findTestObject('Object Repository/Validate_SO_Quote_Account/Page_Frameworks (Demo)/div_Release Order'))

WebUI.takeFullPageScreenshot()

WebUI.click(findTestObject('Object Repository/Validate_SO_Quote_Account/Page_Frameworks (Demo)/div_Print Delivery Docket_isc_2P4'))

WebUI.delay(2)

WebUI.takeFullPageScreenshot()

WebUI.click(findTestObject('Object Repository/Validate_SO_Quote_Account/Page_Frameworks (Demo)/td_Release (S)'))
