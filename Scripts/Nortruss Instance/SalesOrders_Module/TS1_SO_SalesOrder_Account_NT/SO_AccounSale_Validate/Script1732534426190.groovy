...
WebUI.click(findTestObject('Object Repository/SalesOrder_NT/Page_Frameworks (Demo)/img'))

WebUI.setText(findTestObject('Object Repository/SalesOrder_NT/Page_Frameworks (Demo)/input_Customer No_CustId'), '17179')

WebUI.click(findTestObject('Object Repository/SalesOrder_NT/Page_Frameworks (Demo)/td_Find'))

WebUI.click(findTestObject('Object Repository/SalesOrder_NT/Page_Frameworks (Demo)/div_Invoices, Orders, Quotes, Projects  Jobs'))
