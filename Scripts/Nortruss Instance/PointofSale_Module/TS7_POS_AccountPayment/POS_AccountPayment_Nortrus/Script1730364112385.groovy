...
transactionNum = WebUI.getText(findTestObject('Object Repository/Page_Frameworks (Demo)/div_invoiceNum'))
...
WebUI.click(findTestObject('Object Repository/Page_Frameworks (Demo)/div_PayAccount'))

WebUI.click(findTestObject('Object Repository/Page_Frameworks (Demo)/td_Customer_isc_R6'))
...
//WebUI.click(findTestObject('Object Repository/Page_Frameworks (Demo)/input_Payment Amount_valuePayment'))
WebUI.setText(findTestObject('Object Repository/Page_Frameworks (Demo)/input_Payment Amount_valuePayment'), '25.45')

WebUI.click(findTestObject('Object Repository/Page_Frameworks (Demo)/td_Tendering'))
...
//WebUI.click(findTestObject('Object Repository/Page_Frameworks (Demo)/td_Kino Manalo (manaki)'))
//WebUI.click(findTestObject('Object Repository/Page_Frameworks (Demo)/td_'))
