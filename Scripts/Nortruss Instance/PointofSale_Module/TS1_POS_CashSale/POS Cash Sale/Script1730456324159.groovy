...
WebUI.doubleClick(findTestObject('Object Repository/Page_Frameworks (Demo)/ainput_Quantity_quantityOrdered'))

WebUI.setText(findTestObject('Object Repository/Page_Frameworks (Demo)/ainput_Quantity_quantityOrdered'), '2')
