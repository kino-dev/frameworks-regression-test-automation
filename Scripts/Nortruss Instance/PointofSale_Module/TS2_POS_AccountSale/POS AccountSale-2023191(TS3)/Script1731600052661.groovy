...
WebUI.click(findTestObject('Object Repository/Page_Frameworks (Demo)/td_Close (O)'))
...
WebUI.sendKeys(findTestObject('Object Repository/Page_Frameworks (Demo)/input_LM_tallyQuantity_1'), '2')
