...
WebUI.click(findTestObject('Object Repository/Page_Frameworks (Demo)/div_Actions'))

WebUI.click(findTestObject('Object Repository/Page_Frameworks (Demo)/div_ResumeSale'))

WebUI.setEncryptedText(findTestObject('Object Repository/Page_Frameworks (Demo)/input_Operator No_operatorId_1'), 'uzzxF8+Oh1A=')

WebUI.setEncryptedText(findTestObject('Object Repository/Page_Frameworks (Demo)/input_PIN_pin_1_2'), 'uzzxF8+Oh1A=')

WebUI.click(findTestObject('Object Repository/Page_Frameworks (Demo)/div_OK_1'))

WebUI.setText(findTestObject('Object Repository/Page_Frameworks (Demo)/input_From Number_fromTran_1'), docketNumber)

WebUI.setText(findTestObject('Object Repository/Page_Frameworks (Demo)/input_To Number_toTran'), docketNumber)

WebUI.click(findTestObject('Object Repository/Page_Frameworks (Demo)/img_Date_isc_PG'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Object Repository/Page_Frameworks (Demo)/td_Today'))

WebUI.click(findTestObject('Object Repository/Page_Frameworks (Demo)/td_Find_1'))

WebUI.click(findTestObject('Object Repository/Page_Frameworks (Demo)/a_40559183'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.setText(findTestObject('Object Repository/Page_Frameworks (Demo)/input_Operator No_operatorId_1_2'), '2237')

WebUI.setText(findTestObject('Object Repository/Page_Frameworks (Demo)/input_PIN_pin_1'), '2237')

WebUI.click(findTestObject('Object Repository/Page_Frameworks (Demo)/div_OK_1_2'))

WebUI.click(findTestObject('Object Repository/Page_Frameworks (Demo)/img_dropdownLogout'))

WebUI.click(findTestObject('Object Repository/Page_Frameworks (Demo)/div_Logout'))
