...
transaction_Number = WebUI.getText(findTestObject('Object Repository/Page_Frameworks (Demo)/transaction_Number'))

println(transaction_Number)

WebUI.doubleClick(findTestObject('Object Repository/Page_Frameworks (Demo)/input_Customer_idCustX'))

WebUI.setText(findTestObject('Object Repository/Page_Frameworks (Demo)/input_Customer_idCustX'), '17179')

WebUI.click(findTestObject('Object Repository/Page_Frameworks (Demo)/div_Tiffany Brown (17179) (1)'))

WebUI.click(findTestObject('Object Repository/Page_Frameworks (Demo)/img_Select a Value_isc_FP'))

WebUI.click(findTestObject('Object Repository/Page_Frameworks (Demo)/div_Stock Return'))

WebUI.click(findTestObject('Object Repository/Page_Frameworks (Demo)/img_Reason_isc_FU'))

WebUI.click(findTestObject('Object Repository/Page_Frameworks (Demo)/div_01 - Stock Returned_1'))
...
WebUI.click(findTestObject('Object Repository/Page_Frameworks (Demo)/span'))

WebUI.click(findTestObject('Object Repository/Page_Frameworks (Demo)/div_Load Details'))

WebUI.click(findTestObject('Object Repository/Page_Frameworks (Demo)/div_Refund All'))

WebUI.click(findTestObject('Object Repository/Page_Frameworks (Demo)/div_Finish (S)'))

WebUI.click(findTestObject('Object Repository/Page_Frameworks (Demo)/td_OK'))

WebUI.click(findTestObject('Object Repository/Page_Frameworks (Demo)/img_Despatch Method_isc_QR'))

WebUI.click(findTestObject('Object Repository/Page_Frameworks (Demo)/div_PICKU - Pick up From Store'))

WebUI.setText(findTestObject('Object Repository/Page_Frameworks (Demo)/input_Address_deliverToAddress1'), 'PO Box 1094')
